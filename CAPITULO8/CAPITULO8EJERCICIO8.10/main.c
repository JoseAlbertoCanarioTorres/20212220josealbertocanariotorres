...
void F3(vendedor A[], int T) /* Esta funcion se utiliza para generar un listado de todos aquellos vendedores que en el año vendieron menos de $300,000. */
{
int I, J;
float SUM;
...
/* Esta funcion se usa para imprimir el numero de empleado, el nombre del banco y el numero de cuenta de todos aquellos empleados a quienes se les
