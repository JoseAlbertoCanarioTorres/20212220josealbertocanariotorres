...
#include <string.h>
/* Uniones.
El programa muestra la manera como se declara una unión, asi como la forma de acceso a los campos de las variables de tipo unión tanto para asignación de valores como para lectura y escritura. */
...
/* Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumno reciben valores, ingresamos los valores de los campos de tres formas diferentes.
Los campos de a1 reciben valores directamente, los campos de a2 se leen en el programa principal, y los campos de a3 reciben valores a través de una función. */
printf("%d Alumno 2\n");
...
puts(a2,carrera);
printf("%.2f\n", a2.promedio);
puts(a.personales.celular); /* Escribe basura. */
